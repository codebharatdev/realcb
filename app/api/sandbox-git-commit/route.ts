...
export async function POST(request: NextRequest) {
  try {
    ...
    const testResult = await global.activeSandbox.runCode('print("✅ Sandbox is working!")');
...
"""
        ...
        print(f"✅ Committed with message: ${commitMessage}")
        ...
        print(f"✅ Updated remote with authentication: https://***@github.com/${userData.githubUsername}/${repoName}.git")
        ...
        try:
            ...
            print("✅ Force pushed to GitHub main branch")
...
print("📋 Executing git setup and commit...")
...
print(json.dumps(result))
    ...
    if (parsedResult.success) {
        console.log('[sandbox-git-commit] ✅ Git commit successful:', parsedResult);
        return NextResponse.json({
            success: true,
        ...
        console.error('[sandbox-git-commit] ❌ Git commit failed:', parsedResult);
        return NextResponse.json({
            success: false,
